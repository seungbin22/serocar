				...
				<div class="container">
					<div class="row">
						...
						<div class="text-center">
							<div class="tab-img">
								<div id="sgp5">
									<img src="./resources/images/carsange/k81.png" alt="어비스 블랙 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="mcd5">
									<img src="./resources/images/carsange/k82.png" alt="세레니티 화이트 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="tlb5">
									<img src="./resources/images/carsange/k83.png" alt="어비스 블랙 펄">
								</div>
								<div class="display-none" id="svd5">
									<img src="./resources/images/carsange/k84.png" alt="세레니티 화이트 펄">
								</div>
								<div class="display-none" id="rpt5">
									<img src="./resources/images/carsange/k85.png" alt="큐레아티드 실버 메탈">
								</div>
								<div class="display-none" id="wtc5">
									<img src="./resources/images/carsange/k86.png" alt="트랜스미션 블루 펄">
								</div>
					...
					<div class="row bottom-box">
						...
						<div class="col-sm-6">
							<div class="tab-car-color-txt">
								<ul>
									<li class="sgp5"><a href="#"> </a></li>
									<li class="mcd5"><a href="#"></a></li>
									<li class="tlb5"><a href="#"></a></li>
									<li class="svd5"><a href="#"></a></li>
									<li class="rpt5"><a href="#"></a></li>
									<li class="wtc5"><a href="#"></a></li>
								</ul>
							</div>
								...
								<div class="table-accordion">
												...
												<div class="container container-wide">
													<div class="row mtn-30 image-gallery">
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/K8Ex1.png">
																<img src="./resources/images/carsange/K8Ex1.png" alt="gallery" />
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/K8Ex2.png">
																<img src="./resources/images/carsange/K8Ex2.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>Wheel Frame</h3>
																</div>
															</div>
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/K8Ex3.png">
																<img src="./resources/images/carsange/K8Ex3.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>car steering</h3>
																</div>
															</div>
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/K8Ex4.png">
																<img src="./resources/images/carsange/K8Ex4.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>car steering</h3>
																</div>
															</div>
											...
											<div class="page-content-wrapper sp-y">
												<div class="gallery-page-content">
													<div class="container container-wide">
														<div class="row mtn-30 image-gallery">
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/k8In1.png">
																	<img src="./resources/images/carsange/k8In1.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Disk Break</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/k8In2.png">
																	<img src="./resources/images/carsange/k8In2.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Wheel Frame</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/k8In3.png">
																	<img src="./resources/images/carsange/k8In3.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>car steering</h3>
																	</div>
																</div>
									...
									<dl>
										...
										<dd>
											...
											가솔린, 하이브리드 <br>
											연비 :
											복합 17.1~18km/ℓ 도심 17.2~18.2, 고속 16.9~17.7 <br>
											출력 :
											230hp/180hp 엔진<br>
											엔진 :
											I4 싱글터보
