	...
	<div id="fullpage">
		...
		<div class="g-content">
			...
			<div class="likeComment">
                        ...
                        <span><input type="text" class="form-control" id="exampleFormControlInput1" value="${getCarLike}" readonly></span>
                        <i class="fa fa-comment-o fa-2x" id="iconC"></i> 
                        <span>123${carLike}asdfasdf${car.carNum}11asdfa${memberEmail }카넘${carNum}</span>
                     </div>
                     </div>
		</div>
