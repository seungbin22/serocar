				...
				<div class="container">
					<div class="row">
						...
						<div class="text-center">
							<div class="tab-img">
								<div id="sgp9">
									<img src="./resources/images/carsange/santafe1.png" alt="어비스 블랙 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="mcd9">
									<img src="./resources/images/carsange/santafe2.png" alt="세레니티 화이트 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="tlb9">
									<img src="./resources/images/carsange/santafe3.png" alt="어비스 블랙 펄">
								</div>
								<div class="display-none" id="svd9">
									<img src="./resources/images/carsange/santafe4.png" alt="세레니티 화이트 펄">
								</div>
								<div class="display-none" id="rpt9">
									<img src="./resources/images/carsange/santafe5.png" alt="큐레아티드 실버 메탈">
								</div>
								<div class="display-none" id="wtc9">
									<img src="./resources/images/carsange/santafe6.png" alt="트랜스미션 블루 펄">
								</div>
					...
					<div class="row bottom-box">
						...
						<div class="col-sm-6">
							<div class="tab-car-color-txt">
								<ul>
									<li class="sgp9"><a href="#"> </a></li>
									<li class="mcd9"><a href="#"></a></li>
									<li class="tlb9"><a href="#"></a></li>
									<li class="svd9"><a href="#"></a></li>
									<li class="rpt9"><a href="#"></a></li>
									<li class="wtc9"><a href="#"></a></li>
								</ul>
							</div>
												...
												<div class="container container-wide">
													<div class="row mtn-30 image-gallery">
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/santfeEx1.png">
																<img src="./resources/images/carsange/santfeEx1.png" alt="gallery" />
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/santfeEx2png">
																<img src="./resources/images/carsange/santfeEx2.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>Wheel Frame</h3>
																</div>
															</div>
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/santfeEx3.png">
																<img src="./resources/images/carsange/santfeEx3.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>car steering</h3>
																</div>
															</div>
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/santfeEx4.png">
																<img src="./resources/images/carsange/santfeEx4.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>car steering</h3>
																</div>
															</div>
											...
											<div class="page-content-wrapper sp-y">
												<div class="gallery-page-content">
													<div class="container container-wide">
														<div class="row mtn-30 image-gallery">
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/santfeIn1.png">
																	<img src="./resources/images/carsange/santfeIn1.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Disk Break</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/santfeIn2.png">
																	<img src="./resources/images/carsange/santfeIn2.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Wheel Frame</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/santfeIn3.png">
																	<img src="./resources/images/carsange/santfeIn3.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>car steering</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/santfeIn4.png">
																	<img src="./resources/images/carsange/santfeIn4.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>car steering</h3>
																	</div>
																</div>
