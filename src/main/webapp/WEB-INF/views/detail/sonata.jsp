				...
				<div class="container">
					<div class="row">
						...
						<div class="text-center">
							<div class="tab-img">
								<div id="sgp4">
									<img src="./resources/images/carsange/sonata1.png" alt="어비스 블랙 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="mcd4">
									<img src="./resources/images/carsange/sonata2.png" alt="세레니티 화이트 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="tlb4">
									<img src="./resources/images/carsange/sonata3.png" alt="어비스 블랙 펄">
								</div>
								<div class="display-none" id="svd4">
									<img src="./resources/images/carsange/sonata4.png" alt="세레니티 화이트 펄">
								</div>
								<div class="display-none" id="rpt4">
									<img src="./resources/images/carsange/sonata5.png" alt="큐레아티드 실버 메탈">
								</div>
								<div class="display-none" id="wtc4">
									<img src="./resources/images/carsange/sonata6.png" alt="트랜스미션 블루 펄">
								</div>
					...
					<div class="row bottom-box">
						...
						<div class="col-sm-6">
							<div class="tab-car-color-txt">
								<ul>
									<li class="sgp4"><a href="#"> </a></li>
									<li class="mcd4"><a href="#"></a></li>
									<li class="tlb4"><a href="#"></a></li>
									<li class="svd4"><a href="#"></a></li>
									<li class="rpt4"><a href="#"></a></li>
									<li class="wtc4"><a href="#"></a></li>
								</ul>
							</div>
								...
								<div class="table-accordion">
												...
												<div class="container container-wide">
													<div class="row mtn-30 image-gallery">
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/sonataEx1.png">
																<img src="./resources/images/carsange/sonataEx1.png" alt="gallery" />
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/sonataEx2.png">
																<img src="./resources/images/carsange/sonataEx2.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>Wheel Frame</h3>
																</div>
															</div>
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/sonataEx3.png">
																<img src="./resources/images/carsange/sonataEx3.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>car steering</h3>
																</div>
															</div>
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/sonataEx4.png">
																<img src="./resources/images/carsange/sonataEx4.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>car steering</h3>
																</div>
															</div>
											...
											<div class="page-content-wrapper sp-y">
												<div class="gallery-page-content">
													<div class="container container-wide">
														<div class="row mtn-30 image-gallery">
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/sonataIn1.png">
																	<img src="./resources/images/carsange/sonataIn1.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Disk Break</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/sonataIn2.png">
																	<img src="./resources/images/carsange/sonataIn2.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Wheel Frame</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/sonataIn3.png">
																	<img src="./resources/images/carsange/sonataIn3.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>car steering</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/sonataIn4.png">
									...
									<dl>
										...
										<dd>
											...
											LPG, 가솔린 <br>
											연비 :
											복합 9.9~13.8km/ℓ 도심 8.7~12.3, 고속 11.6~16.2 <br>
											출력 :
											146~290hp 엔진<br>
											엔진 :
											I4, 싱글터보
