				...
				<div class="container">
					<div class="row">
						...
						<div class="text-center">
							<div class="tab-img">
								<div id="sgp3">
									<img src="./resources/images/carsange/ioniq1.png" alt="어비스 블랙 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="mcd3">
									<img src="./resources/images/carsange/ioniq2.png" alt="세레니티 화이트 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="tlb3">
									<img src="./resources/images/carsange/ioniq3.png" alt="어비스 블랙 펄">
								</div>
								<div class="display-none" id="svd3">
									<img src="./resources/images/carsange/ioniq4.png" alt="세레니티 화이트 펄">
								</div>
								<div class="display-none" id="rpt3">
									<img src="./resources/images/carsange/ioniq5.png" alt="큐레아티드 실버 메탈">
								</div>
								<div class="display-none" id="wtc3">
									<img src="./resources/images/carsange/ioniq6.png" alt="트랜스미션 블루 펄">
								</div>
					...
					<div class="row bottom-box">
						...
						<div class="col-sm-6">
							<div class="tab-car-color-txt">
								<ul>
									<li class="sgp3"><a href="#"> </a></li>
									<li class="mcd3"><a href="#"></a></li>
									<li class="tlb3"><a href="#"></a></li>
									<li class="svd3"><a href="#"></a></li>
									<li class="rpt3"><a href="#"></a></li>
									<li class="wtc3"><a href="#"></a></li>
								</ul>
							</div>
								...
								<div class="table-accordion">
												...
												<div class="container container-wide">
													<div class="row mtn-30 image-gallery">
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/avanteEx1.png">
												...
												<div class="gallery-page-content">
													<div class="container container-wide">
														<div class="row mtn-30 image-gallery">
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/ioniqIn2.png">
																	<img src="./resources/images/carsange/ioniqIn2.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Wheel Frame</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/ioniqIn3.png">
																	<img src="./resources/images/carsange/ioniqIn3.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>car steering</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/ioniqIn4.png">
																	<img src="./resources/images/carsange/ioniqIn4.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>car steering</h3>
																	</div>
																</div>
									...
									<dl>
										...
										<dd>
											...
											전기 <br>
											주행 :
											319~458km 1회 충전 시 <br>
											연비 :
											복합 4.7~5.2km/kWh 도심 5.3~5.9, 고속 4.2~4.5 <br>
											출력 :
			 								125~239kW 모터 168~320hp (단순환산치)<br>
											용량 :
											58~77.4kWh 배터리
										</dd>
									</dl>
