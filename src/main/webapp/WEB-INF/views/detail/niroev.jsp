				...
				<div class="container">
					<div class="row">
						...
						<div class="text-center">
							<div class="tab-img">
								<div id="sgp6">
									<img src="./resources/images/carsange/niro1.png" alt="어비스 블랙 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="mcd6">
									<img src="./resources/images/carsange/niro2.png" alt="세레니티 화이트 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="tlb6">
									<img src="./resources/images/carsange/niro3.png" alt="어비스 블랙 펄">
								</div>
								<div class="display-none" id="svd6">
									<img src="./resources/images/carsange/niro4.png" alt="세레니티 화이트 펄">
								</div>
								<div class="display-none" id="rpt6">
									<img src="./resources/images/carsange/niro5.png" alt="큐레아티드 실버 메탈">
								</div>
								<div class="display-none" id="wtc6">
									<img src="./resources/images/carsange/niro6.png" alt="트랜스미션 블루 펄">
								</div>
					...
					<div class="row bottom-box">
						...
						<div class="col-sm-6">
							<div class="tab-car-color-txt">
								<ul>
									<li class="sgp6"><a href="#"> </a></li>
									<li class="mcd6"><a href="#"></a></li>
									<li class="tlb6"><a href="#"></a></li>
									<li class="svd6"><a href="#"></a></li>
									<li class="rpt6"><a href="#"></a></li>
									<li class="wtc6"><a href="#"></a></li>
								</ul>
							</div>
								...
								<div class="table-accordion">
												...
												<div class="container container-wide">
													<div class="row mtn-30 image-gallery">
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/niroEx1.png">
																<img src="./resources/images/carsange/niroEx1.png" alt="gallery" />
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/niroEx2.png">
																<img src="./resources/images/carsange/niroEx2.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>Wheel Frame</h3>
																</div>
															</div>
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/niroEx3.png">
																<img src="./resources/images/carsange/niroEx3.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>car steering</h3>
																</div>
															</div>
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/niroEx4.png">
																<img src="./resources/images/carsange/niroEx4.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>car steering</h3>
																</div>
															</div>
											...
											<div class="page-content-wrapper sp-y">
												<div class="gallery-page-content">
													<div class="container container-wide">
														<div class="row mtn-30 image-gallery">
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/niroIn1.png">
																	<img src="./resources/images/carsange/niroIn1.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Disk Break</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/niroIn2.png">
																	<img src="./resources/images/carsange/niroIn2.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Wheel Frame</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/niroIn3.png">
																	<img src="./resources/images/carsange/niroIn3.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>car steering</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/niroIn14.png">
																	<img src="./resources/images/carsange/niroIn4.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>car steering</h3>
																	</div>
																</div>
									...
									<dl>
										...
										<dd>
											...
											전기 <br>
											연비 :
											복합 5.3km/kWh 도심 5.9, 고속 4.8 <br>
											출력 :
											150kW 모터 201hp (단순환산치)<br>
											용량 :
											64.8kWh 배터리
										</dd>
									</dl>
