				...
				<div class="container">
					<div class="row">
						...
						<div class="text-center">
							<div class="tab-img">
								<div id="sgp8">
									<img src="./resources/images/carsange/stinger1.png" alt="어비스 블랙 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="mcd8">
									<img src="./resources/images/carsange/stinger2.png" alt="세레니티 화이트 펄 (블랙잉크)">
								</div>
								<div class="display-none" id="tlb8">
									<img src="./resources/images/carsange/stinger3.png" alt="어비스 블랙 펄">
								</div>
								<div class="display-none" id="svd8">
									<img src="./resources/images/carsange/stinger4.png" alt="세레니티 화이트 펄">
								</div>
								<div class="display-none" id="rpt8">
									<img src="./resources/images/carsange/stinger5.png" alt="큐레아티드 실버 메탈">
								</div>
								<div class="display-none" id="wtc8">
									<img src="./resources/images/carsange/stinger6.png" alt="트랜스미션 블루 펄">
								</div>
					...
					<div class="row bottom-box">
						...
						<div class="col-sm-6">
							<div class="tab-car-color-txt">
								<ul>
									<li class="sgp8"><a href="#"> </a></li>
									<li class="mcd8"><a href="#"></a></li>
									<li class="tlb8"><a href="#"></a></li>
									<li class="svd8"><a href="#"></a></li>
									<li class="rpt8"><a href="#"></a></li>
									<li class="wtc8"><a href="#"></a></li>
								</ul>
							</div>
								...
								<div class="table-accordion">
												...
												<div class="container container-wide">
													<div class="row mtn-30 image-gallery">
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/stingerEx1.png">
																<img src="./resources/images/carsange/stingerEx1.png" alt="gallery" />
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/stingerEx2.png">
																<img src="./resources/images/carsange/stingerEx2.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>Wheel Frame</h3>
																</div>
															</div>
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/stingerEx3.png">
																<img src="./resources/images/carsange/stingerEx3.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>car steering</h3>
																</div>
															</div>
														...
														<div class="col-sm-6 col-lg-3">
															<div class="gallery-item" data-mfp-src="./resources/images/carsange/stingerEx4.png">
																<img src="./resources/images/carsange/stingerEx4.png" alt="gallery" />
																<div class="gallery-item__text">
																	<h3>car steering</h3>
																</div>
															</div>
											...
											<div class="page-content-wrapper sp-y">
												<div class="gallery-page-content">
													<div class="container container-wide">
														<div class="row mtn-30 image-gallery">
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/stingerIn1.png">
																	<img src="./resources/images/carsange/stingerIn1.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Disk Break</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/stingerIn2.png">
																	<img src="./resources/images/carsange/stingerIn2.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>Wheel Frame</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/stingerIn3.png">
																	<img src="./resources/images/carsange/stingerIn3.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>car steering</h3>
																	</div>
																</div>
															...
															<div class="col-sm-6 col-lg-3">
																<div class="gallery-item" data-mfp-src="./resources/images/carsange/stingerIn4.png">
																	<img src="./resources/images/carsange/stingerIn4.png" alt="gallery" />
																	<div class="gallery-item__text">
																		<h3>car steering</h3>
																	</div>
																</div>
									...
									<dl>
										...
										<dd>
											...
											가솔린 <br>
											연비 :
											복합 8.5~11.2km/ℓ 도심 7.5~9.8, 고속 10.2~13.4 <br>
											출력 :
											304~373hp 엔진<br>
											엔진 :
											I4, V6 트윈터보
