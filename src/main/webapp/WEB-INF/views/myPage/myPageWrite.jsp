                                       ...
                                       <c:when
                                          ...
                                          <c:forEach var="article" items="${articleList }">
                                             ...
                                             <tr>
                                                ...
                                                <td class="display_sm_none" style="text-align: center;"><a href="./myPage_delete?comNum=${article.comNum}&memberEmail=${memberEmail}&businessNum=${businessNum}&memberNickname=${memberNickname}" ><img src="./resources/images/delete.png" style="width: 40px; height: 30px;"/></a></td>
                                             </tr>
                                          </c:forEach>
                                       </c:when>
                                    </c:choose>
