...
<body>
   <form action="/modify_notice" method="POST" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td><input type="text" name="notice_title" id="notice_title"
                                             ...
                                             class="input01 required width_400" value="${notice_title }"/> <span
                                    ...
                                    <tbody>
                                       <tr>
                                          <th scope="row"><label for="contents">내용 작성</label><span
                                             class="icon_required">필수</span></th>
                                          <td><textarea name="notice_content" id="editor"
                                                cols="30" rows="30" class="input01 width_100p"
                                                placeholder="내용을 입력해주세요">${notice_content }</textarea></td>
                                       </tr>
                                    </tbody>
                                 </table>
