                                    ...
                                    <c:choose>
                                       <c:when
                                          ...
                                          <c:forEach var="article" items="${articleList2 }">
                                             ...
                                             <tr>
                                             <td class="display_sm_none"><input type="checkbox" name="chk" id="chk" class="checkbox_RecipeBoard" value="${articel.notice_num}" ></td>
												...
												<td class="display_sm_none"><a href="./managerDelete_notice?notice_num=${article.notice_num}" ><img src="./resources/images/delete.png" style="width: 40px; height: 30px;"/></a></td>
                                             </tr>
                                          </c:forEach>
                                       </c:when>
                                    </c:choose>
