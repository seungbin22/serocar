										...
										<c:when test="${articleList!=null && pageInfo.listCount>0 }">
											...
											<c:forEach var="article" items="${articleList }">
												...
												<tr>
													...
													<td class="display_sm_none">${article.comNum }</td>
													...
													<td class="display_lg_none"><a href="#"
														class="writer" onclick="return false;">${article.memberNickname}</a></td>
													<td class="display_sm_none">${article.comDate}</td>
													<td class="display_sm_none">${article.comViews}</td>
													<td class="display_sm_none">${article.comReco}</td>
													<td class="display_sm_none"><a href="./managerDeleteCom?comNum=${article.comNum}" ><img src="./resources/images/delete.png" style="width: 40px; height: 30px;"/></a></td>
												</tr>
											</c:forEach>
										</c:when>
									</c:choose>
