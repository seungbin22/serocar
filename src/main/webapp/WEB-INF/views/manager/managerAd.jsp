                  ...
                  <div class="board">
                     <table class="list type1">
                        ...
                        <tbody>
                                    <c:choose>
                                       <c:when
                                          ...
                                          <c:forEach var="article" items="${articleList2 }">
                                             ...
                                             <tr>
                                             <td class="display_sm_none" style="text-align: center;"><input type="checkbox" name="chk" id="chk" class="checkbox_RecipeBoard" value="${articel.ad_num}" ></td>
                                                ...
                                                <td class="display_sm_none" style="text-align: center;">${article.ad_date}</td>
                                    ...
                                    <td class="display_sm_none" style="text-align: center;"><a href="./managerDelete_ad?ad_num=${article.ad_num}" ><img src="./resources/images/delete.png" style="width: 40px; height: 30px;"/></a></td>
                                             </tr>
                                          </c:forEach>
                                       </c:when>
                                    </c:choose>
